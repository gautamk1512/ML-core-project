...
# def load_model_view(request):
    # time.sleep(95)    
print("start")
model_path=os.path.join(settings.MEDIA_ROOT,'modelr.h5')
model_path2=r"C:\Users\SIRT\Downloads\ALL models\model\vgg16\diabetic_retinopathy_model_with_pretrained.h5"
model_path3=r"C:\Users\SIRT\Downloads\ALL models\model\resnet52\diabetic_retinopathy_model_with_pretrained.h5"
model = tf.keras.models.load_model(model_path,compile=False)
model2 = tf.keras.models.load_model(model_path,compile=False)
model3= tf.keras.models.load_model(model_path,compile=False)
